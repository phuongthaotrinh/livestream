...
const initTypeHasPlatform = require('../Models/TypeHasPlatForm');
...
async function setup() {
    ...
    const TypeHasPlatForm = initTypeHasPlatform(sequelize);
    ...
    return [
        ...
        FormTemplates,FormField,TypeHasPlatForm,Group
    ];
}
setup()